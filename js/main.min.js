...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":12,"./modules/sliders/init-coaches-slider":16,"./modules/sliders/init-reviews-slider":17,"./modules/tabs/init-tabs":18,"./modules/video/init-video":20,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";
...
var videoContainer = document.querySelector('.about__video-wrapper');
var videoLink = videoContainer.querySelector('.video__link');
var videoButton = videoContainer.querySelector('.about__video-button');
